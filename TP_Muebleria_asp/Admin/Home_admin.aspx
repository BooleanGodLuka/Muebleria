            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="<%Response.Write("/Admin/Admin_usuarios.aspx"); %>" class="btn btn-primary">Administrar</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="<%Response.Write("/Admin/Admin_Productos.aspx"); %>" class="btn btn-primary">Administrar</a>
                        <a href="<%Response.Write("/Admin/Productos_alta.aspx"); %>" class="btn btn-primary">Alta</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="<%Response.Write("/Admin/Admin_Facturas.aspx"); %>" class="btn btn-primary">Administrar</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="<%Response.Write("/Admin/Admin_Reporte.aspx"); %>" class="btn btn-primary">Ver</a>
                    </div>
                </div>
            </div>
        </div>
